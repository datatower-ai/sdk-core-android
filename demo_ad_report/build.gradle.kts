...
android {
    ...
    defaultConfig {
        ...
        applicationId("com.nodetower.android_ad_report")
        minSdkVersion(minSdkVersion)
        targetSdkVersion(targetSdkVersion)

        versionName = buildProps["adVersionName"]!!.toString()
        versionCode = buildProps["adVersionCode"]!!.toString().toInt()
